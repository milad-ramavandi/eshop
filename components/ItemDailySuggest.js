...
import styles from './ItemDailySuggest.module.css'

const ItemDailySuggest = (props) => {
  return (
    <div className={styles.ItemDailySuggestContainer}>
      <div className={`${styles.dailySuggestImageContainer}`}>
        {props.data.incredibleOffers === true ? (
          <Image
            className={`${styles.dailySuggestImage}`}
            alt={props.data.name}
...
export default ItemDailySuggest;
